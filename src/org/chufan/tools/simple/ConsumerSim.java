package org.chufan.tools.simple;
...
public class ConsumerSim {
	...
	public static void main(String args[]) {
		ConsumerSim example = new ConsumerSim();
		args = new String[]{"10","tony","1","192.168.78.56","9092"};
	...
	/**
	 * get last offset of topic and partition
	 * @param consumer
	 * @param topic
	 * @param partition
	 * @param whichTime
